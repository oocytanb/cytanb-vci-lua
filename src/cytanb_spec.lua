...
describe('Test cytanb owner user', function ()
    ...
    it('Message', function ()
        ...
        cytanb.OnMessage(cytanb.DedicatedCommentMessageName, cbMap.cbCytanbComment)
        cytanb.OnMessage(cytanb.DedicatedNotificationMessageName, cbMap.cbCytanbNotification)
